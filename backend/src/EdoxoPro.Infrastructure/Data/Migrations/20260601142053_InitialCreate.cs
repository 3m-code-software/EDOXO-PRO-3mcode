...
namespace EdoxoPro.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_Delegates_DelegateId",
            ...
            migrationBuilder.CreateTable(
                name: "DamagedStockItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DamagedStockId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<double>(type: "float", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Total = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DamagedStockItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DamagedStockItems_DamagedStocks_DamagedStockId",
                        column: x => x.DamagedStockId,
                        principalTable: "DamagedStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DamagedStockItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    SystemQuantity = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseReturnItems_PurchaseReturns_ReturnId",
                        column: x => x.ReturnId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 1, 14, 20, 46, 226, DateTimeKind.Utc).AddTicks(7395), null, null, true, false, "Samsung", null, null },
                    { 2, new DateTime(2026, 6, 1, 14, 20, 46, 226, DateTimeKind.Utc).AddTicks(8535), null, null, true, false, "Nike", null, null },
                    { 3, new DateTime(2026, 6, 1, 14, 20, 46, 226, DateTimeKind.Utc).AddTicks(8538), null, null, true, false, "Local Brand", null, null }
                });

            migrationBuilder.InsertData(
                table: "ProductCategories",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "IsActive", "IsDeleted", "Name", "ParentId", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 1, 14, 20, 46, 225, DateTimeKind.Utc).AddTicks(2893), null, null, true, false, "Electronics", null, null, null },
                    { 2, new DateTime(2026, 6, 1, 14, 20, 46, 225, DateTimeKind.Utc).AddTicks(4536), null, null, true, false, "Clothing", null, null, null },
                    { 3, new DateTime(2026, 6, 1, 14, 20, 46, 225, DateTimeKind.Utc).AddTicks(4539), null, null, true, false, "Food & Beverages", null, null, null },
                    { 4, new DateTime(2026, 6, 1, 14, 20, 46, 225, DateTimeKind.Utc).AddTicks(4541), null, null, true, false, "Office Supplies", null, null, null },
                    { 5, new DateTime(2026, 6, 1, 14, 20, 46, 225, DateTimeKind.Utc).AddTicks(4543), null, null, true, false, "Hardware", null, null, null }
                });

            migrationBuilder.InsertData(
                table: "ProductUnits",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "IsActive", "IsDeleted", "Name", "ShortName", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 1, 14, 20, 46, 226, DateTimeKind.Utc).AddTicks(9622), null, true, false, "Piece", "pc", null, null },
                    { 2, new DateTime(2026, 6, 1, 14, 20, 46, 227, DateTimeKind.Utc).AddTicks(1168), null, true, false, "Kilogram", "kg", null, null },
                    { 3, new DateTime(2026, 6, 1, 14, 20, 46, 227, DateTimeKind.Utc).AddTicks(1172), null, true, false, "Liter", "L", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DamagedStockItems_DamagedStockId",
                table: "DamagedStockItems",
                column: "DamagedStockId");

            migrationBuilder.CreateIndex(
                name: "IX_DamagedStockItems_ProductId",
                table: "DamagedStockItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DamagedStocks_ReferenceNumber",
                table: "DamagedStocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryAudits_AuditNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ReferenceNumber",
                table: "Purchases",
                column: "ReferenceNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleReturnItems_ReturnId",
